...
class SingleAccountModel: NSObject {
    ...
    func setAccountBookDataInModel(){
        ...
        for sourceItem in itemAccounts {
            ...
            //累加
            if sourceItem.iconTitle == "工作" || sourceItem.iconTitle == "奖金" {
                
                if let income = Float(sourceItem.money){
                    totalIncome += income
                }
                ...
                if let cost = Float(sourceItem.money){
                    totalCost += cost
                }
                
            }
            //print("setAccountBookDataInModel \(sourceItem.iconTitle)")
